package database.envisioned.utility;
...
public class StatementUtility {
    ...
    private static StatementUtility instance = null;
    private ConnectionType connectionType;

    public static StatementUtility getInstance() {
        if(instance == null){
            instance = new StatementUtility();
        }
